  ...
  return (
    <section className="relative overflow-hidden border-y border-gold-500/8 bg-navy-900/40 py-20 sm:py-28 lg:py-32">
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        <Reveal>
          <span
            className="font-[family-name:var(--ferri-display)] text-6xl leading-none text-gold-500/40 sm:text-7xl"
            aria-hidden="true"
          >
            &ldquo;
          </span>
          <h2 className="mx-auto mt-2 max-w-3xl font-[family-name:var(--ferri-display)] text-3xl font-light leading-[1.15] text-cream-100 sm:text-4xl md:text-5xl">
            {d.title}
          </h2>
