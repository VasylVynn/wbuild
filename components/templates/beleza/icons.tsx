/*
 * Inline SVG icons for the beleza template (dependency-free, matching the
 * restaurant/salon approach of not pulling an icon library into the render
 * path). `currentColor` throughout so callers colour them via CSS.
 */
...
export function CalendarIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden="true">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 2.5v4M16 2.5v4M3.5 10h17" />
    </svg>
  );
}
