...
const items = [
  ...
  {
    q: "Скільки це коштує?",
    a: "Створити сайт і опублікувати його — безкоштовно: він одразу працює на адресі нашого сервісу. 999 грн на рік коштує лише власний домен — його реєстрація та обслуговування.",
  },
  {
    q: "Коли запрацює мій домен?",
    a: "Ви обираєте назву домену, ми перевіряємо, чи вона вільна. Після оплати реєструємо її та підключаємо до сайту — зазвичай протягом чотирьох годин.",
  },
  {
    q: "Що буде через рік?",
    a: "Домен оплачений на рік від дня оплати. Умови продовження ми надішлемо вам перед завершенням терміну — нічого не спишеться автоматично. Сайт на адресі сервісу працює далі.",
  },
];
