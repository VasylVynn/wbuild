...
export default function BlockSheet({
  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      />
      {/* sheet */}
      <div className="animate-rise absolute inset-x-0 bottom-0 z-50 mx-auto flex max-h-[90vh] max-w-2xl flex-col rounded-t-sheet bg-surface shadow-[0_-12px_44px_rgba(51,41,28,.2)] [&>div:last-child]:pb-6">
        <div className="flex justify-center pt-2.5 pb-0.5">
          <div className="h-1.5 w-11 rounded-full bg-line-strong" />
        </div>
        <div className="flex items-center justify-between border-b border-line px-5 pb-3.5 pt-1">
          <div>
            <div className="text-[12px] font-extrabold uppercase tracking-[0.08em] text-honey-text">
              Редагування секції
            </div>
