...
/**
 * The form for editing ONE block — container-agnostic (P2): the mobile
 * bottom-sheet (BlockSheet) and the desktop right inspector both render this.
 * The form is generated from `getBlockFields(type)` (§4.1 — the same registry
 * drives render + validation + this form, so they cannot drift). Editing
 * happens on a local draft of the props; «Зберегти» hands the whole props
 * object back to the shell, which persists the full blocks array.
 */
