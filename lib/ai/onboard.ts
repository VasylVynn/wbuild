...
- Кнопку «Створюй сайт» ніколи не блокуй питаннями; на «досить/просто зроби» — зупиняйся миттєво. Все зібране зберігай через save_facts (services, description, city тощо).
