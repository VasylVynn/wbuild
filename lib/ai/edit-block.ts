...
- ВИГЛЯД (кольори, кнопки, фони, відступи, шрифти) цей інструмент не змінює — але продукт це вміє: не кажи «неможливо», а зазнач у note, що вигляд змінюється окремим інструментом update_style. Ця відмова колись була правдою і перестала бути нею 2026-08-12.
- Якщо інструкція просить те, чого цей блок справді не підтримує (нові типи полів, кошик/оплата, онлайн-запис, довільний код) — зроби лише можливу частину (або залиш props без змін) і коротко поясни в полі note, що саме неможливо і що індивідуальні зміни можна замовити кнопкою «Хочу кастомні зміни» в редакторі. Не вигадуй обхідних рішень.`;
