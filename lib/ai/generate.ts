...
- Назви КОНКРЕТНИЙ предмет цієї справи, а не абстракцію «взагалі»: грумінг маленьких порід → "small fluffy dog after grooming"; пекарня на заквасці → "rustic sourdough loaf crust close-up"; теніс → "clay court surface and tennis ball in low sun". Загальні текстури без предмета дають гарну, але порожню картинку — саме на це скаржаться власники.
- Бери предмет із зібраних фактів (що саме роблять, для кого, з чим працюють) — не вигадуй асортимент, якого немає.
